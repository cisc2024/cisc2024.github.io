    ...
    return (
        <div className="container">
                ...
                <table className="table table-bordered border-black text-center">
                    <tbody>
                        <tr>
                            ...
                            <td className="p-3">2024/06/18~2024/07/14</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="p-3">2024/08/04</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="mb-5">
                ...
                <p>論文以摘要形式投稿，得以中文或英文撰寫。英文長度限600字，中文長度限800字。稿件格式為A4 大小，四邊各留 25mm，單行間距，無須列印頁碼。英文字體 Times New Roman 10 點，中文字體標楷體 10 點。詳細摘要格式見第三十四屆全國資訊安全會議網站所提供的 WORD、Latex 範例檔，存檔格式為 PDF。</p>
                <ul>
